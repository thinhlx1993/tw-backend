...
va_inference_model = {
    ...
    "bounding_box": fields.Nested(
        api_version_1_web.model("bounding_box_model", bounding_box_model)
    ),
    "detections": fields.List(
        fields.Nested(
            api_version_1_web.model(
...
va_alert_inference_model = {
    "inference_list": fields.List(
        fields.Nested(api_version_1_web.model("va_tag_model", va_inference_model))
    ),
    ...
    "mission_instance_id": fields.String(example="5ca4b5a9-4565-4e70-b6a5-5ad8e70d6155"),
}

va_inference_api_model = api_version_1_web.model(
