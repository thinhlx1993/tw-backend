...
from src.version_handler import api_version_1_agent
...
va_inference_model = {
    ...
    "bounding_box": fields.Nested(
        api_version_1_agent.model("bounding_box_model", bounding_box_model)
    ),
    "detections": fields.List(
        fields.Nested(
            api_version_1_agent.model(
...
va_alert_inference_model = {
    "inference_list": fields.List(
        fields.Nested(api_version_1_agent.model("va_tag_model", va_inference_model))
    ),
...
va_inference_api_model = api_version_1_agent.model(
