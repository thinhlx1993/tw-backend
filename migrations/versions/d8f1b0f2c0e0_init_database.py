...
def upgrade():
    ...
    if 'teams' not in tables:
        op.create_table('teams',
                        sa.Column('teams_id', postgresql.UUID(as_uuid=True),
    ...
    op.create_table('robot',
                    sa.Column('robot_id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'),
                              nullable=False),
    ...
    if 'user' not in tables:
        op.create_table('user',
                        sa.Column('user_id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'),
                                  nullable=False),
    ...
    if 'user_role' not in tables:
        op.create_table('user_role',
                        sa.Column('role_id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'),
                                  nullable=False),
    ...
    op.create_table('mission',
                    sa.Column('mission_id', postgresql.UUID(as_uuid=True), server_default=sa.text('uuid_generate_v4()'),
    ...
    if 'user_teams_mapping' not in tables:
        op.create_table('user_teams_mapping',
                        sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False),
                        sa.Column('teams_id', postgresql.UUID(as_uuid=True), nullable=False),
    ...
    op.create_table('user_preference',
                    sa.Column('preference_id', postgresql.UUID(as_uuid=True),
                              server_default=sa.text('uuid_generate_v4()'), nullable=False),
    ...
    op.create_table('mission_instance',
                    sa.Column('mission_instance_id', postgresql.UUID(as_uuid=True),
                              server_default=sa.text('uuid_generate_v4()'), nullable=False,
