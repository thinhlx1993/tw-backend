...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "deploy_va_engine", sa.Boolean(), server_default="false", nullable=True
        ),
        sa.Column(
            "va_engine_status", sa.String(length=128), server_default="", nullable=False
        ),
        ...
        sa.Column(
            "rosbridge_support", sa.Boolean(), server_default="false", nullable=False
        ),
        sa.Column(
            "modified_at",
            sa.DateTime(timezone=True),
        ...
        sa.Column(
            "status_details", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "init_config", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
        sa.PrimaryKeyConstraint("robot_id"),
    )
    if "role_permission_mapping_log" not in tables:
        op.create_table(
            "role_permission_mapping_log",
    ...
    if "user" not in tables:
        op.create_table(
            ...
            sa.Column(
                "mfa_enabled", sa.Boolean(), server_default="false", nullable=True
            ),
            sa.Column("mfa_secret", postgresql.BYTEA(), nullable=True),
            sa.Column("phone_number", sa.String(length=128), nullable=True),
            sa.Column(
                "is_email_verified", sa.Boolean(), server_default="false", nullable=True
            ),
    ...
    if "user_teams_mapping" not in tables:
        op.create_table(
            ...
            sa.Column("teams_id", sa.String(128), nullable=False),
            sa.Column(
                "is_default", sa.Boolean(), server_default="false", nullable=True
            ),
            sa.ForeignKeyConstraint(
                ["teams_id"],
                ["teams.teams_id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "modified_at", sa.DateTime(), server_default=sa.text("now()"), nullable=True
        ),
        sa.Column("default_page", sa.String(length=128), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "timezone", sa.TEXT(), nullable=True, comment="Timezone for schedule"
        ),
        sa.Column(
            "last_updated_at",
            sa.DateTime(),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.DateTime(),
            nullable=True,
            comment="Start time for the mission",
        ),
        sa.Column(
            "end_timestamp",
            sa.DateTime(),
            nullable=True,
            comment="End time for the mission",
        ),
        sa.Column(
            "last_updated_at",
            sa.DateTime(),
